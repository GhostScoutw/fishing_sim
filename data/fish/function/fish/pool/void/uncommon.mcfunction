...
execute if score fish_roll fish.pool.roll matches 1..25 run function fish:fish/catalog/uncommon/test
execute if score fish_roll fish.pool.roll matches 26..50 run function fish:fish/catalog/uncommon/tuna
execute if score fish_roll fish.pool.roll matches 51..75 run function fish:fish/catalog/uncommon/goldfish
