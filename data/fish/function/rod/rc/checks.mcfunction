...
execute unless score @s fish.item_cooldown matches 1.. as @n[tag=rod.this,tag=!aj.fishing_rod.animation.cast_idle.playing] at @s run return run function fish:rod/rc/charge_cast
