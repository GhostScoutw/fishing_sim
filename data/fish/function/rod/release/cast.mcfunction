...
execute if score @p[tag=this.release] fish.rod.reel_charge matches ..10 run return run tellraw @s {"text":"Hold right click to charge your throw strength!","color":"red"}
