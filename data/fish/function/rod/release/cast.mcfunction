...
execute if score @p[tag=this.release] fish.rod.reel_charge matches ..10 run function animated_java:fishing_rod/animations/charging/stop
execute if score @p[tag=this.release] fish.rod.reel_charge matches ..10 run function animated_java:fishing_rod/animations/idle/play
execute if score @p[tag=this.release] fish.rod.reel_charge matches ..10 run return run tellraw @p[tag=this.release] {"text":"Hold right click to charge your throw strength!","color":"red"}
