...
execute if score @s fish.bobber.bobbing matches -15 at @s align y run function fish:rod/bobber/caught_wave
...
execute if score @s fish.bobber.bobbing matches 0 at @s align y run function fish:rod/bobber/caught_wave
