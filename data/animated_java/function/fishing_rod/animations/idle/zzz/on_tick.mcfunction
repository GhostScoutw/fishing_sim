...
execute if score @s aj.idle.frame matches -1 run function animated_java:fishing_rod/animations/idle/zzz/commands_keyframe_loop_patch
...
function animated_java:fishing_rod/animations/idle/zzz/apply_frame with storage aj:temp args
