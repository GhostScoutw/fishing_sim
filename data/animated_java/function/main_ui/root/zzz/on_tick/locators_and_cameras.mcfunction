...
function animated_java:main_ui/root/zzz/on_tick/select_locator_locator with entity @s data.locators.locator
function animated_java:main_ui/root/zzz/on_tick/select_locator_locator6 with entity @s data.locators.locator6
function animated_java:main_ui/root/zzz/on_tick/select_locator_locator2 with entity @s data.locators.locator2
